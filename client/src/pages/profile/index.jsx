...
const Profile = () => {
  ...
  return (
    <div className="bg-[#1b1c24] min-h-[100vh] flex items-center justify-center flex-col gap-10 px-4 py-10">
      <div className="flex flex-col gap-10 w-full max-w-md md:max-w-2xl">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
          {/* Avatar */}
          <div
            className="relative flex-shrink-0 flex items-center justify-center w-32 h-32 md:w-48 md:h-48"
        ...
        {/* Save button — full width, outside the avatar/form row */}
        <Button
